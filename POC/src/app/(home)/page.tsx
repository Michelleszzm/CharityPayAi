    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center bg-white py-12">
        ...
        <div className="mt-4 text-[18px] leading-[22px] text-[#020328]/65">
          CharityPay empowers every nonprofit to fundraise globally with ease.
      ...
      <div>
        <div className="relative flex h-[311px] w-full flex-col items-center justify-center bg-[#FFF1C5]">
          <Image
            src={bgImage4}
            alt="bg-image4"
            width={2560}
      ...
      <div className="flex flex-col items-center justify-center">
        {list2.map((item, index) => (
          <motion.div
            ...
            className={cn(
              "flex h-[560px] w-full items-center justify-center gap-10",
      ...
      <div className="relative flex h-[396px] items-center justify-between">
        ...
        <div className="relative z-2 flex w-full flex-col items-center justify-center">
          ...
          <div className="mt-6 text-[18px] leading-[24px] text-[#000]/80">
            Start raising more for free - request your free access to CharityPay
            today!
          </div>
          {!isLogin && (
            <div
