...
export default function Login() {
  const { loginModalOpen, setLoginModalOpen, setRegisterModalOpen } =
    useModalStore()
  const { setIsLogin, setAccount } = useUserStore()
          ...
          <Form {...form}>
            ...
            >
              ...
              <div className="text-left">
                <button
                  type="button"
                  className="text-[14px] leading-[18px] text-[#1890FF] hover:underline"
                >
                  Forgot password?
                </button>
              </div>
